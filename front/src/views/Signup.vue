<template>
  <div class="signup">
    ...
    <main class="container">
      ...
      <h1 align="center" class="h2">Rejoignez-nous !</h1>
      ...
      <div class="row px-3">
        <div class="col col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 userdata-form border-tertiary mt-3 mb-2 shadow bg-my-light-grey">
          <b-form @submit="onSubmit" class="mt-3">
            ...
            <b-button type="submit" variant="my-logo-color-darker" class="my-3 shadow">Inscription</b-button>
          </b-form>
      ...
      <p class="mt-3 mb-5">
        Déja inscrit ?
        <router-link to="/login" class="text-my-logo-color-darker">Se connecter</router-link>
      </p>
